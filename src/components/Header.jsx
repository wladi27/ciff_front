        ...
        <Menu
          menuButton={
            <MenuButton className="relative hover:bg-secondary-100 p-2 rounded-lg transition-colors">
              <RiNotification3Line className="text-gray-900"/>
              <span className="absolute -top-0.5 right-0 bg-red-600 py-0.5 px-[5px] box-content text-black rounded-full text-[8px] font-bold">
                2
              </span>
            </MenuButton>
          }
        ...
        <Menu
          menuButton={
            <MenuButton className="flex items-center gap-x-2 hover:bg-secondary-100 p-2 rounded-lg transition-colors">
              ...
              <span className="text-gray-900">Wladimir Figuera</span>
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="flex flex-col text-sm">
                ...
                <span className="text-xs text-gray-500">wladi@ati.com</span>
              </div>
            </Link>
          </MenuItem>
